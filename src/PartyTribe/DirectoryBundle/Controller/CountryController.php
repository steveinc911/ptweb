...
use PartyTribe\DirectoryBundle\Entity\Country;
use PartyTribe\DirectoryBundle\Form\CountryType;
...
class CountryController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('PartyTribeDirectoryBundle:Country')->findAll();
     ...
     * @Method("POST")
     * @Template("PartyTribeDirectoryBundle:Country:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('PartyTribeDirectoryBundle:Country')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("PartyTribeDirectoryBundle:Country:edit.html.twig")
     */
