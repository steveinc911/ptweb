...
use PartyTribe\DirectoryBundle\Entity\Photo;
use PartyTribe\DirectoryBundle\Form\PhotoType;
...
class PhotoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('PartyTribeDirectoryBundle:Photo')->findAll();
     ...
     * @Method("POST")
     * @Template("PartyTribeDirectoryBundle:Photo:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('PartyTribeDirectoryBundle:Photo')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("PartyTribeDirectoryBundle:Photo:edit.html.twig")
     */
