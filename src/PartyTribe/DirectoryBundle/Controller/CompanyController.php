...
use PartyTribe\DirectoryBundle\Entity\Company;
use PartyTribe\DirectoryBundle\Form\CompanyType;
...
class CompanyController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('PartyTribeDirectoryBundle:Company')->findAll();
     ...
     * @Method("POST")
     * @Template("PartyTribeDirectoryBundle:Company:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('PartyTribeDirectoryBundle:Company')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("PartyTribeDirectoryBundle:Company:edit.html.twig")
     */
