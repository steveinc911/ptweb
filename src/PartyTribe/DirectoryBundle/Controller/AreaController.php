...
use PartyTribe\DirectoryBundle\Entity\Area;
use PartyTribe\DirectoryBundle\Form\AreaType;
...
class AreaController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('PartyTribeDirectoryBundle:Area')->findAll();
     ...
     * @Method("POST")
     * @Template("PartyTribeDirectoryBundle:Area:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('PartyTribeDirectoryBundle:Area')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("PartyTribeDirectoryBundle:Area:edit.html.twig")
     */
