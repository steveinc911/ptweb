...
use PartyTribe\DirectoryBundle\Entity\City;
use PartyTribe\DirectoryBundle\Form\CityType;
...
class CityController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('PartyTribeDirectoryBundle:City')->findAll();
     ...
     * @Method("POST")
     * @Template("PartyTribeDirectoryBundle:City:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('PartyTribeDirectoryBundle:City')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("PartyTribeDirectoryBundle:City:edit.html.twig")
     */
