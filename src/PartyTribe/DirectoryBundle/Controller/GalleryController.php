...
use PartyTribe\DirectoryBundle\Entity\Gallery;
use PartyTribe\DirectoryBundle\Form\GalleryType;
...
class GalleryController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('PartyTribeDirectoryBundle:Gallery')->findAll();
     ...
     * @Method("POST")
     * @Template("PartyTribeDirectoryBundle:Gallery:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('PartyTribeDirectoryBundle:Gallery')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("PartyTribeDirectoryBundle:Gallery:edit.html.twig")
     */
