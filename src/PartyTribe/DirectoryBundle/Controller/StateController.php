...
use PartyTribe\DirectoryBundle\Entity\State;
use PartyTribe\DirectoryBundle\Form\StateType;
...
class StateController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('PartyTribeDirectoryBundle:State')->findAll();
     ...
     * @Method("POST")
     * @Template("PartyTribeDirectoryBundle:State:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('PartyTribeDirectoryBundle:State')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("PartyTribeDirectoryBundle:State:edit.html.twig")
     */
