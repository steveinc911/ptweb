...
use PartyTribe\DirectoryBundle\Entity\Location;
use PartyTribe\DirectoryBundle\Form\LocationType;
...
class LocationController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('PartyTribeDirectoryBundle:Location')->findAll();
     ...
     * @Method("POST")
     * @Template("PartyTribeDirectoryBundle:Location:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('PartyTribeDirectoryBundle:Location')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("PartyTribeDirectoryBundle:Location:edit.html.twig")
     */
